package com.corso.java.orangee.OtherProjectsAndTest.Tombola.tombolaGit;
...
public class Tombola {
    ...
    public static void main(String[] args) {
        ...
        for (c = 1; c <= nrCartelle; c++) {
            ...
            tombola.cartelle.put(c, cartella);
        }

        for (Integer nrCartella : tombola.cartelle.keySet()) {
            tombola.cartelle.get(nrCartella).stampaCartella();
        }

        List<Integer> elencoNumeriEstratti = tombola.estrazioni();
...
//_______________________________________________________METODI DI CLASSE______________________________________________________________
     ...
     * UNA SERIE DI NUMERI(Due per l'ambo, tre per il terno ect..)
     * GENERATI RANDOM
