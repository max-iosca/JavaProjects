package com.corso.java.orange.OtherProjectsAndTest.EserciziRemoBoh.Uguali.src;
/*
 Scrivere una classe Java Uguali(con metodo main) che chiede all'utente di inserire due numeri interi...
